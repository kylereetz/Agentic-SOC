...
### 3. QUILL-TRIAGE ([TriageAgent](./backend/soc/agents/intelligence/triage.py))
...
### 4. QUILL-CORRELATOR ([CorrelatorAgent](./backend/soc/agents/intelligence/correlator.py))
...
### 5. QUILL-LIBRARIAN ([LibrarianAgent](./backend/soc/agents/intelligence/librarian.py))
...
### 6. QUILL-HUNTER ([HunterAgent](./backend/soc/agents/intelligence/hunter.py))
...
### 7. GAGGLE-LOG-GUARDIAN ([LogGuardianAgent](./backend/soc/agents/operations/log_guardian.py))
...
### 8. GAGGLE-TRAFFIC-SIEVE ([TrafficSieveAgent](./backend/soc/agents/operations/traffic_sieve.py))
...
### 9. QUILL-ENDPOINT-ANALYST ([EndpointAnalystAgent](./backend/soc/agents/intelligence/endpoint_analyst.py))
...
### 10. QUILL-INVESTIGATOR ([InvestigatorAgent](./backend/soc/agents/intelligence/investigator.py))
...
### 11. QUILL-FORENSICS ([ForensicsAgent](./backend/soc/agents/intelligence/forensics.py))
...
### 12. QUILL-MALWARE-PATHOLOGIST ([MalwarePathologistAgent](./backend/soc/agents/intelligence/malware_pathologist.py))
...
### 14. WEDGE-RESPONDER ([ResponderAgent](./backend/soc/agents/action/responder.py))
...
### 15. WEDGE-PATCHADVISOR ([PatchAdvisor](./backend/soc/agents/action/patch_advisor.py))
...
### 19. GAGGLE-SCOUT ([ScoutAgent](./backend/soc/agents/operations/scout.py))
...
### 20. GAGGLE-TOPOLOGY ([TopologyMapper](./backend/soc/agents/operations/topology_mapper.py))
...
### 23. GAGGLE-WATCHDOG ([WatchdogAgent](./backend/soc/agents/operations/watchdog.py))
...
### 24. FLYWAY-HISTORIAN ([HistorianAgent](./backend/soc/agents/business/historian.py))
...
### 25. FLYWAY-STRATEGIST ([FictitiousPlaySolver](./backend/soc/agents/business/game_theory_solver.py))
