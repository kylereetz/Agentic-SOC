...
A_Cloud[13. SENTINEL - CLOUD - WRAITH]
end
...
A_Orches-- >| gRPC Provisioning | Scaling
    ...
    Queue -.->| topic_cloud / topic_identity | A_Cloud & A_Foren
    Queue -.->| topic_malware | A_Malw & A_Hunter
    Queue -.->| topic_remediation | A_Resp & A_Patch
    
    %% Hive Consensus Callbacks
    A_Endpt & A_Cloud & A_Malw & A_Hunter & A_Invest -.->| publishes to orchestrator_callbacks | Queue
...
A_Cloud-- >| Cloud Admin APIs | ExternalAPI
...
A_Red -.->| Injects Synthetic Threats (discovery_events) | Queue
