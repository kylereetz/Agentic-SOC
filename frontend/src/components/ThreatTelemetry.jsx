...
import { DollarSign, AlertTriangle, Skull, TrendingUp, Clock, ShieldOff, ShieldCheck } from 'lucide-react';
          ...
          <div className="flex-1 overflow-y-auto">
            {incidents.length === 0 ? (
              <div className="flex flex-col items-center justify-center p-12 opacity-50 space-y-3">
                ...
                <p className="h-body text-[#6B7280]">No quantified risks exceed baseline limits</p>
              </div>
            ) : incidents.map((inc, i) => {
