...
class TestSpecializedTools(unittest.TestCase):
    ...
    def test_ot_analyst_modbus_tool(self):
        ...
        result = agent.tools.dispatch("inspect_modbus_traffic", {"target_ip": "10.0.40.50"})
    ...
    def test_id_analyst_ad_tool(self):
        ...
        result = agent.tools.dispatch("audit_ad_privileges", {"entity_id": "KR\\bad_actor"})
    ...
    def test_remediation_safety_tool(self):
        ...
        # Test a critical IP
        critical_result = agent.tools.dispatch("verify_remediation_safety", {
            "strategy": "ISOLATE",
        ...
        safe_result = agent.tools.dispatch("verify_remediation_safety", {
            "strategy": "ISOLATE",
