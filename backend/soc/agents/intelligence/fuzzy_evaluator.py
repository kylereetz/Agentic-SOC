...
class FuzzyThreatEvaluator:
    METRIC_THRESHOLDS = {
        "entropy_sigma": {"stable": (-1.0, 0.0, 1.0, 2.5), "volatile": (1.5, 2.5, 3.5, 4.5), "chaotic": (3.5, 4.5, 100.0, 100.0)},
        "failed_logins": {"stable": (-1.0, 0.0, 2.0, 4.0), "volatile": (3.0, 4.0, 6.0, 8.0), "chaotic": (6.0, 8.0, 100.0, 100.0)},
        "out_degree": {"stable": (-1.0, 0.0, 10.0, 15.0), "volatile": (12.0, 15.0, 25.0, 30.0), "chaotic": (25.0, 30.0, 1000.0, 1000.0)},
        "in_degree_velocity": {"stable": (-1.0, 0.0, 2.0, 5.0), "volatile": (4.0, 6.0, 15.0, 20.0), "chaotic": (15.0, 20.0, 1000.0, 1000.0)},
        "beaconing_jitter_variance": {"stable": (50.0, 100.0, 1000.0, 1000.0), "volatile": (5.0, 10.0, 50.0, 100.0), "chaotic": (-1.0, 0.0, 5.0, 10.0)}, # Low variance is chaotic
        "payload_asymmetry": {"stable": (-1.0, 0.0, 2.0, 5.0), "volatile": (3.0, 5.0, 20.0, 30.0), "chaotic": (25.0, 30.0, 10000.0, 10000.0)},
        "process_lineage_depth": {"stable": (-1.0, 0.0, 2.0, 4.0), "volatile": (3.0, 4.0, 6.0, 8.0), "chaotic": (7.0, 8.0, 50.0, 50.0)},
        "resource_variance": {"stable": (-1.0, 0.0, 1.5, 2.5), "volatile": (2.0, 2.5, 4.0, 5.0), "chaotic": (4.0, 5.0, 100.0, 100.0)},
        "file_mod_velocity": {"stable": (-1.0, 0.0, 5.0, 10.0), "volatile": (8.0, 10.0, 50.0, 80.0), "chaotic": (60.0, 80.0, 10000.0, 10000.0)},
        "subnet_velocity": {"stable": (-1.0, 0.0, 10.0, 50.0), "volatile": (40.0, 50.0, 300.0, 500.0), "chaotic": (400.0, 500.0, 20000.0, 20000.0)}, # mph / km/h equivalent
        "token_access_freq": {"stable": (-1.0, 0.0, 10.0, 20.0), "volatile": (15.0, 20.0, 50.0, 80.0), "chaotic": (60.0, 80.0, 10000.0, 10000.0)},
    }
    ...
    def fuzzify_metric(self, name: str, val: float):
        if name not in self.METRIC_THRESHOLDS:
            return {"Stable": 1.0, "Volatile": 0.0, "Chaotic": 0.0} # Ignore unknown, treat as stable
