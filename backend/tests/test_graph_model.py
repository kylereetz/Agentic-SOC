...
async def test_graph_pipeline():
    ...
    flow_1 = {"src_ip": "10.0.0.5", "dst_ip": "10.0.0.10", "dst_port": 502, "protocol": "TCP", "bytes": 100}
    ...
    if alert1 and alert1.get("unmapped", {}).get("graph_anomaly") == "Structural Relational Anomaly":
        logger.info("Success: First interaction correctly triggered Structural deviation.")
    else:
    ...
    flow_2 = {"src_ip": "10.0.0.5", "dst_ip": "192.168.1.100", "dst_port": 443, "protocol": "TCP", "bytes": 5000}
    ...
    for i in range(20, 55):
        flow_scan = {"src_ip": "10.0.0.5", "dst_ip": f"10.0.0.{i}", "dst_port": 445, "protocol": "TCP", "bytes": 50}
