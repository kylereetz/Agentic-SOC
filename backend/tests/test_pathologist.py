"""
Automated Test Suite: Test Pathologist.
...
async def test_pathologist_sandbox_parsing():
                    ...
                    "api_calls": [
                        {
                            ...
                            "args": {"ApplicationName": "svchost.exe"},
                        },
                        {
                            "api": "VirtualAllocEx",
                            "args": {"AllocationType": "MEM_COMMIT | MEM_RESERVE"},
                        },
                        {"api": "WriteProcessMemory", "args": {"Size": 4096}},
                        {
                            "api": "CreateRemoteThread",
                            "args": {"StartAddress": "0x7FF8..."},
                        },
                    ],
                }
            ]
    ...
    assert (
        "T1055" in tactics_str or "process injection" in report.intent_summary.lower()
    )
